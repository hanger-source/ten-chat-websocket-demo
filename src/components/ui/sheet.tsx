  ...
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
        ...
        right:
          "inset-y-0 right-0 h-full w-3/4 border-l data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 md:data-[state=closed]:slide-out-to-right md:data-[state=open]:slide-in-from-right",
      },
    },
    defaultVariants: {
      side: "right",
...
interface SheetContentProps
  ...
  overlayClassName?: string; // Add this line
}
