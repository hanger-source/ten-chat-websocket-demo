    ...
    <div className={cn("mb-6 relative", className)}>
      <div className="relative bg-white rounded-lg shadow-sm pt-4 p-4 border border-gray-200">
        <div className="absolute top-0 left-4 -translate-y-1/2 flex space-x-2 bg-white px-2 z-10">
          <span className="px-3 py-1 rounded-md text-sm font-normal bg-gradient-to-r from-blue-600 via-purple-500 to-pink-500 bg-clip-text text-transparent border-transparent">音质</span>
        </div>
            ...
            <div className="flex items-center justify-between space-x-2">
              ...
              <div className="flex items-center space-x-2 ml-auto"> {/* Added ml-auto here */}
                ...
                {replaceableVoiceOption && (
                  ...
                  >
                    <span className="bg-gradient-to-r from-blue-700 to-purple-700 bg-clip-text text-transparent">更换音质</span>
                  </Button>
                )}
              </div>
            </div>
